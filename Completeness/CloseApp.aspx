<%@ Page Language="C#" MasterPageFile="~/Blank.master" AutoEventWireup="true" 
    CodeFile="CloseApp.aspx.cs" Inherits="Completeness_CloseApp" Title="DWMS - Close App (Completeness)" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
    <div class="title">
        <asp:Label ID="TitleLabel" runat="server" Text="Close Application" />
    </div>
    <asp:Panel ID="ConfirmPanel" runat="server" CssClass="reminder-green top10 bottom15"
        Visible="false" EnableViewState="false">
        The application(s) have been closed.
    </asp:Panel>
    <asp:Panel ID="FormPanel" runat="server" CssClass="inputform" DefaultButton="CloseButton">
        <div class="header">
            <div class="left">
                Close Application</div>
            <div class="right">
                <!---->
            </div>
        </div>
            ...
            <table>
                <tr>
                    <td valign="top" style="width: 30%;">
                        <span class="label">Application to Close</span>                        
                    </td>
                    <td>       

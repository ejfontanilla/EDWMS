<%@ Page Language="C#" MasterPageFile="~/OneColumn.master" AutoEventWireup="true"
    CodeFile="AssignmentReport.aspx.cs" Inherits="Completeness_AssignmentReport" Title="DWMS - Assignment Report (Completeness)" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
    ...
    <asp:Panel ID="FormPanel" runat="server" CssClass="inputform">
        <telerik:RadComboBox ID="UserRadComboBox" runat="server" AllowCustomText="True"
            ...
            EmptyMessage="Type a Completeness OIC..." Width="210"
        ...
        <telerik:RadGrid ID="GroupByDateRadGrid" runat="server" AutoGenerateColumns="False" AllowSorting="True"
            ...
            <MasterTableView AllowFilteringByColumn="false" Width="100%">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Completeness OIC" UniqueName="CompletenessOIC"
                        DataField="CompletenessOIC" AutoPostBackOnFilter="true" DataType="System.String" SortExpression="CompletenessOIC" HeaderStyle-Width="200px">
                        <ItemTemplate>

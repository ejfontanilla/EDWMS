...
public partial class Completeness_PendingAssignment : System.Web.UI.Page
{
    ...
    private DataTable GetData(bool withGroup)
    {
        ...
        if (!withGroup)
            return docAppDb.GetPendingAssignmentApps(docAppId, dateInFrom, dateInTo, AppStatusEnum.Verified, sectionId, nric);
        else
            return docAppDb.GetPendingAssignmentAppsVerificationDates(docAppId, dateInFrom, dateInTo, AppStatusEnum.Verified, sectionId, nric);
    }
    ...
    private DataTable GetDataForDetailTable(DateTime verificationDateIn)
    {
        ...
        // Get the Sets for the user's section
        return docAppDb.GetPendingAssignmentSetsByVerificationDateIn(verificationDateIn, docAppId, dateInFrom, dateInTo, AppStatusEnum.Verified, sectionId, nric);
    }

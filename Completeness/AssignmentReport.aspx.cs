...
public partial class Completeness_AssignmentReport : System.Web.UI.Page
{
    ...
    private DataTable GetData()
    {
        ...
        */
        ...
        if (!status.Equals("-1"))
        {
            ...
            //return docAppDb.GetCompletenessOfficersForAssignedCasesReportDetails(completenessOic, docAppId, RefNoRadComboBox.Text.Trim(), appStatusEnum, dateInFrom, dateInTo, nric);
            return docAppDb.GetCompletenessOfficersForAssignedCasesReportDetails(completenessOic, docAppId, DocAppRadTextBox.Text.Trim(), appStatusEnum, dateInFrom, dateInTo, nric);
        }
        else
            //return docAppDb.GetCompletenessOfficersForAssignedCasesReportDetails(completenessOic, docAppId, RefNoRadComboBox.Text.Trim(), null, dateInFrom, dateInTo, nric);
            return docAppDb.GetCompletenessOfficersForAssignedCasesReportDetails(completenessOic, docAppId, DocAppRadTextBox.Text.Trim(), null, dateInFrom, dateInTo, nric);

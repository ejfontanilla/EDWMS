...
<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
    <div class="title">
        Search Documents for Own Department Sets (Read Only)
    </div>
        ...
        <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" AllowSorting="True"
            ...
            <MasterTableView AllowFilteringByColumn="false" Width="100%">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Set Number" UniqueName="SetNo" DataField="SetNo" HeaderStyle-Width="140px"

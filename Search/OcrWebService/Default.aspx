<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Search_OcrWebService_Default"
    MasterPageFile="~/OneColumn.master" Title="DWMS - OCR / Web Service Error Report" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
    <div class="title">
        OCR / Web Service Error Report</div>
    <asp:Panel ID="FormPanel" runat="server" CssClass="inputform" DefaultButton="SearchButton">
        ...
        <telerik:RadGrid ID="RadGrid2" runat="server" AutoGenerateColumns="False" AllowSorting="True"
            ...
            <MasterTableView DataKeyNames="OcrMonth, OcrYear" AllowFilteringByColumn="false"
                ...
                <DetailTables>
                    <telerik:GridTableView Width="100%" runat="server" AllowFilteringByColumn="false"
                        ShowHeader="true" BorderColor="#EEEEEE" ClientDataKeyNames="OcrMonth" Name="Child">
                        <NoRecordsTemplate>
                            <div class="wrapper10">
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Error" UniqueName="Department" DataField="Code"

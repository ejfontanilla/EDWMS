...
public partial class Search_ErrorSendingToCDB_Default : System.Web.UI.Page
{
    int sectionId = -1;
    int departmentId = -1;
    ...
    private void PopulateList()
    {
        ...
        RadGrid1.DataSource = ExceptionLogDb.GetErrorSendingToCDB(sectionId, departmentId, dateInFrom, dateInTo);
    }
}
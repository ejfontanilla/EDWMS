<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Search_ErrorSendingToCDB_Default"
    MasterPageFile="~/OneColumn.master" Title="DWMS - Error Sending to CDB" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
    <div class="title">
        Error Sending to CDB</div>
    <asp:Panel ID="FormPanel" runat="server" CssClass="inputform" DefaultButton="SearchButton">
        ...
        <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" AllowSorting="True"
            ...
            <MasterTableView AllowFilteringByColumn="false" Width="100%">
                <SortExpressions>
                    <telerik:GridSortExpression FieldName="VerificationDateOut" SortOrder="Descending">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Date Occured" UniqueName="VerificationDateOut"
                        DataField="VerificationDateOut" AutoPostBackOnFilter="true" DataType="System.String"
                        SortExpression="VerificationDateOut">
                        <ItemTemplate>
                            <%# Eval("VerificationDateOut")%>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Error Message" UniqueName="ErrorMessage"
                        DataField="ErrorMessage" AutoPostBackOnFilter="true" DataType="System.String"
                        SortExpression="ErrorMessage" HeaderStyle-Width="350">
                        <ItemTemplate>
                            <%# Eval("ErrorMessage")%>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderText="No. Of Documents affected" UniqueName="NoOfDocuments"
                        DataField="NoOfDocuments" AutoPostBackOnFilter="true" DataType="System.String"
                        SortExpression="NoOfDocuments" HeaderStyle-Width="100">
                        <ItemTemplate>
                            <%# Eval("NoOfDocuments")%>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>

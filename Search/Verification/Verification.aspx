<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Verification.aspx.cs" Inherits="Search_Verification_Verification" 
MasterPageFile="~/OneColumn.master" Title="DWMS - Verification Report"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
    ...
    <telerik:RadGrid ID="RadGrid2" runat="server" AutoGenerateColumns="False" AllowSorting="True" Skin="Windows7"
        BorderColor="#EEEEEE" GridLines="None" AllowPaging="True" PageSize="20" AllowFilteringByColumn="True"
        EnableLinqExpressions="False" OnDetailTableDataBind="RadGrid2_DetailTableDataBind" 
        ...
        <MasterTableView DataKeyNames="VMonth, VYear" AllowFilteringByColumn="false" Width="100%"
            ...
            <DetailTables>
                <telerik:GridTableView Width="100%" runat="server" AllowFilteringByColumn="false"
                    ShowHeader="true" BorderColor="#EEEEEE" ClientDataKeyNames="VMonth" Name="Child">
                    <NoRecordsTemplate>
                        <div class="wrapper10">
                    ...
                    <Columns>
                        <telerik:GridTemplateColumn HeaderText="Channel" UniqueName="Department"
                            DataField="Code" AutoPostBackOnFilter="true" DataType="System.String" SortExpression="Code">
                            <ItemTemplate>
                                <%# Eval("Channel")%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                         <telerik:GridTemplateColumn HeaderText="No of sets" UniqueName="Department"
                            DataField="Code" AutoPostBackOnFilter="true" DataType="System.String" SortExpression="Code">
                            <ItemTemplate>
            ...
            <Columns>
            <telerik:GridTemplateColumn HeaderText="Month" UniqueName="Division" DataField="Code"
                ...
                <telerik:GridTemplateColumn HeaderText="" UniqueName="Division" DataField="Code"
                    AutoPostBackOnFilter="true" DataType="System.String">
                    <ItemTemplate>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VerificationPerOIC.aspx.cs" Inherits="Search_Verification_VerificationPerOIC" 
MasterPageFile="~/OneColumn.master" Title="DWMS - Verification Per OIC" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
    <div class="title">
        Verification Per OIC Report</div>
    <asp:Panel ID="FormPanel" runat="server" CssClass="inputform" DefaultButton="SearchButton">
        ...
        <telerik:RadGrid ID="RadGrid2" runat="server" AutoGenerateColumns="False" AllowSorting="True"
            ...
            <MasterTableView DataKeyNames="Name, UserId" AllowFilteringByColumn="false"
                Width="100%" HierarchyDefaultExpanded="false" HierarchyLoadMode="Client">
                <NoRecordsTemplate>
                    <div class="wrapper10">
                ...
                <DetailTables>
                    <telerik:GridTableView Width="100%" runat="server" AllowFilteringByColumn="false"
                        ShowHeader="true" BorderColor="#EEEEEE" ClientDataKeyNames="" Name="Child">
                        <NoRecordsTemplate>
                            <div class="wrapper10">
                        ...
                        <Columns>
                            <telerik:GridTemplateColumn HeaderText="Aging Range" UniqueName="Department" DataField="Code"
                                AutoPostBackOnFilter="true" DataType="System.String" SortExpression="Code">
                                <ItemTemplate>
                                    <%# Eval("AgingRange")%>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="No of sets" UniqueName="Department" DataField="Code"
                                AutoPostBackOnFilter="true" DataType="System.String" SortExpression="Code">
                                <ItemTemplate>
                ...
                <Columns>
                    <telerik:GridTemplateColumn HeaderText="Verification OIC" UniqueName="Division" DataField="Code"

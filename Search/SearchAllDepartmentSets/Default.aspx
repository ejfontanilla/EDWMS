...
<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
    <div class="title">
        Search Documents for All Department Sets
    </div>
    <asp:Panel ID="FormPanel" runat="server" CssClass="inputform" DefaultButton="SearchButton">
        ...
        <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" AllowSorting="True"
            ...
            PagerStyle-Position="TopAndBottom" OnClientItemClicking="onClicking" AllowMultiRowSelection="True">
            ...
            <MasterTableView AllowFilteringByColumn="false" Width="100%" DataKeyNames="Id,Status" ClientDataKeyNames="Id,Status">
                ...
                <Columns>
                    ...
                    <telerik:GridDateTimeColumn DataField="VerificationDateIn" HeaderText="Date In" UniqueName="VerificationDateIn" HeaderStyle-Width="120px"
                    ...
                    <telerik:GridTemplateColumn HeaderText="Channel" UniqueName="Source" DataField="Source"
                        AutoPostBackOnFilter="true" DataType="System.String" SortExpression="Source" HeaderStyle-Width="130px">
                        <ItemTemplate>
                            <%# Eval("Source")%>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    ...
                    <%--<telerik:GridTemplateColumn HeaderText="Department" UniqueName="DepartmentCode" DataField="DepartmentCode"
                        AutoPostBackOnFilter="true" DataType="System.String" SortExpression="DepartmentCode">
                        <ItemTemplate>
                            <%# Eval("DepartmentCode").ToString().Replace("_", " ")%>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderText="Section" UniqueName="Code" DataField="Code"
                        AutoPostBackOnFilter="true" DataType="System.String" SortExpression="Code">
                        <ItemTemplate>
                            <%# Eval("Code").ToString().Replace("_", " ")%>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>--%>
                    <telerik:GridTemplateColumn HeaderText="Waiting" UniqueName="WaitingTime" DataField=""
                        AutoPostBackOnFilter="true" DataType="System.String" SortExpression="" HeaderStyle-Width="100px">
                        <ItemTemplate>
                            <asp:Label ID="WaitingTimeLabel" runat="server"></asp:Label>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderText="Processing" UniqueName="ProcessingTime" DataField=""
                        AutoPostBackOnFilter="true" DataType="System.String" SortExpression="" HeaderStyle-Width="100px">
                        <ItemTemplate>

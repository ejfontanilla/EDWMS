...
public partial class Import_SearchSets_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        userDb.GetRole(userId);

        RoleDb roleDb = new RoleDb();
        if (userDb.GetRole(userId).Equals(RoleEnum.System_Administrator.ToString().Replace("_", " ")))
    ...
    protected void RadGrid1OLD_ItemDataBound(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridDataItem)
        {
            ...
            try
            {
                ...
                SetStatusEnum setStatusEnum = (SetStatusEnum)Enum.Parse(typeof(SetStatusEnum), status.Trim(), true);
            ...
            catch (Exception ex)
            {
                ...
                errorLogDb.Insert("SearchAllSets_ItemDataBound", errorMessage);
    ...
    protected void PopulateAcknowledgeNumber()
    {
        //AcknowledgeNumberRadComboBox.Items.Clear();
        //AcknowledgeNumberRadComboBox.DataSourceID = "GetAcknowledgeNumberObjectDataSource";
        //AcknowledgeNumberRadComboBox.DataTextField = "AcknowledgeNumber";
        //AcknowledgeNumberRadComboBox.DataValueField = "AcknowledgeNumber";
    }

    protected void PopulateCmDocumentId()
    {

        CmDocumentIdComboBox.Items.Clear();
        CmDocumentIdComboBox.DataSourceID = "GetCmDocumentIdObjectDataSource";
        CmDocumentIdComboBox.DataTextField = "CmDocumentId";
        CmDocumentIdComboBox.DataValueField = "CmDocumentId";
    }
    ...
    private void PopulateList()
    {
        ...
        if (!status.Equals("-1"))
        {
            ...
            RadGrid1.DataSource = docsetDb.GetSets(channel, setStatusEnum,DocAppRadTextBox.Text.Trim(), departmentId, sectionId, importedByOICUserId, verificationOICUserId, dateInFrom, dateInTo, docAppId, nric, IsUrgentCheckBox.Checked, SkipCategorizationCheckBox.Checked, cmDocumentId, acknowledgeNumber);
        }
        else
            ...
            RadGrid1.DataSource = docsetDb.GetSets(channel, null, DocAppRadTextBox.Text.Trim(), departmentId, sectionId, importedByOICUserId, verificationOICUserId, dateInFrom, dateInTo, docAppId, nric, IsUrgentCheckBox.Checked, SkipCategorizationCheckBox.Checked, cmDocumentId, acknowledgeNumber);

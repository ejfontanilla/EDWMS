...
using Dwms.Web;
using System.Data;
public partial class Search_ArchivalReport_Default : System.Web.UI.Page
{
    int sectionId = -1;
    int departmentId = -1;
    ...
    private void PopulateList()
    {
        ...
        RadGrid1.DataSource = ArchiveDocumentsDb.GetArchivalReport(sectionId, departmentId, dateInFrom, dateInTo);
    }
}
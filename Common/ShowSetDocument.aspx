<%@ Page Title="DWMS - Download Documents (Verification)" Language="C#" MasterPageFile="~/Blank.master" AutoEventWireup="true"
    CodeFile="ShowSetDocument.aspx.cs" Inherits="Common_ShowSetDocument" ValidateRequest="false" %>
...
<asp:Panel ID="FormPanel" runat="server" CssClass="inputform" DefaultButton="SendButton">
    ...
    <asp:Panel ID="SubmitPanel" runat="server" CssClass="form-submit" Width="100%">&nbsp;<asp:Button runat="server" ID="SendButton" CssClass="button-large right20" Text="Download" OnClick="SendButton_onClick"/>
...
<telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" EnableAJAX="true">
    <AjaxSettings>
        ...
        <telerik:AjaxSetting AjaxControlID="RadTreeView1">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="FileSizeLabel"/>
            </UpdatedControls>
        </telerik:AjaxSetting>
    </AjaxSettings>

...
public partial class Main : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (user != null)
        {
            ...
            if (userProfile != null)
            {
                UserNameLabel.Text = "Welcome, " + userProfile.FullName;
                ...
                DepartmentLabel.Text = departmentRow.Name.Trim();
            }
            else
                UserNameLabel.Text = "Hello";

            //do not remove this. later we will link it to the self-service user account page
            //UserNameHyperLink.Text = user.UserName.ToString();

            //check page access rights 
            checkPageAccessRights();

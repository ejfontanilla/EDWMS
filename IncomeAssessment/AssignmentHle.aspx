<%@ Page Language="C#" MasterPageFile="~/OneColumn.master" AutoEventWireup="true"
    CodeFile="AssignmentHle.aspx.cs" Inherits="IncomeAssessment_AssignmentHle" Title="DWMS - HLE Pending Assignment (Income Extraction)" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
        ...
        <asp:Panel ID="FormPanel" runat="server" CssClass="inputform">
            ...
            <telerik:RadGrid ID="PendingAssignmentRadGrid" runat="server" AutoGenerateColumns="False" AllowSorting="False"
                ...
                <MasterTableView AllowFilteringByColumn="false" Width="100%">
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderText="D" UniqueName="LaneCCount" DataField="LaneCCount"
                            AutoPostBackOnFilter="true" DataType="System.String" SortExpression="LaneCCount">
                            <ItemTemplate>
                                <%#Eval("LaneCCount")%>
                            </ItemTemplate>
            ...
            <asp:Panel ID="SubmitPanel1" runat="server" CssClass="form-submit" Width="100%">
                <asp:Button ID="HeaderAssignButton" runat="server" Text="Assign" 
                    CssClass="button-large right20" onclick="AssignButton_Click" />      
            </asp:Panel>
            <%--<div class="top5"><!----></div>--%>
            <div class="header">
                <div class="left">
                    Assigned Cases for Income Extraction Officers</div>
                <div class="right">
                    <!---->
                </div>
            </div>

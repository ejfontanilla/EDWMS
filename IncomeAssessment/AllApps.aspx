<%@ Page Language="C#" MasterPageFile="~/OneColumn.master" AutoEventWireup="true"
    CodeFile="AllApps.aspx.cs" Inherits="IncomeAssessment_AppList" Title="DWMS - All Applications (Income Assessment)" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
    ...
    <asp:Panel ID="FormPanel" runat="server" CssClass="inputform">
        <telerik:RadComboBox ID="StatusRadComboBox" runat="server" ZIndex="30000" Height="200"
            Width="180" DropDownWidth="180" AppendDataBoundItems="true" ExpandAnimation-Duration="100"
            AutoPostBack="false" CausesValidation="false" CollapseAnimation-Duration="200">
            <Items>
        ...
        <telerik:RadComboBox ID="UserRadComboBox" runat="server" AllowCustomText="true" AutoPostBack="true"
            ...
            MarkFirstMatch="True" DataValueField="UserId" Filter="Contains" EmptyMessage="Type an Extraction Officer..."
        ...
        <%--        <telerik:RadComboBox runat="server" ID="RefNoRadComboBox" AllowCustomText="true"
            ...
            EnableAutomaticLoadOnDemand="true" DataTextField="RefNo" MarkFirstMatch="True"
            DataValueField="Id" Filter="Contains" EmptyMessage="Type a Ref No..." DataSourceID="ObjectDataSource1"
            Width="185" EnableVirtualScrolling="true" ItemsPerRequest="20">
        </telerik:RadComboBox>--%>
       ...
       <%-- <telerik:RadComboBox runat="server" ID="AcknowledgeNumberRadComboBox" AllowCustomText="true"
            AutoPostBack="false" CausesValidation="false" EnableAutomaticLoadOnDemand="true"
            DataTextField="AcknowledgeNumber" MarkFirstMatch="True" DataValueField="AcknowledgeNumber"
            Filter="Contains" EmptyMessage="Type a Acknowledge Number..." DataSourceID="GetAcknowledgeNumberObjectDataSource"
            Width="210" EnableVirtualScrolling="true" ItemsPerRequest="20">
        </telerik:RadComboBox>--%>
       ...
       <%-- <telerik:RadComboBox runat="server" ID="NricRadComboBox" AllowCustomText="true" AutoPostBack="false"
            CausesValidation="false" EnableAutomaticLoadOnDemand="true" DataTextField="Nric"
            MarkFirstMatch="True" DataValueField="Nric" Filter="Contains" EmptyMessage="Type a NRIC No..."
            DataSourceID="GetNricObjectDataSource" Width="150" EnableVirtualScrolling="true"
            ItemsPerRequest="20" OnClientTextChange="DocAppRadComboBox_TextChange">
        </telerik:RadComboBox>--%>
        ...
        &nbsp;&nbsp;
        <asp:Button ID="SearchButton" runat="server" Text="Search" CssClass="button-large right10"
        ...
        <telerik:RadMenu ID="RadMenuHomeComplete" runat="server" Skin="Sitefinity" Font-Names="Arial, Helvetica, sans-serif"
            Font-Size="12px" Style="z-index: 1000" Visible="true" Width="100%" OnClientItemClicking="onClicking">
            <Items>
                ...
                <telerik:RadMenuItem Text="Resend" NavigateUrl="#" Font-Bold="true" ImageUrl="~/Data/Images/Action/resend.png">
                </telerik:RadMenuItem>
            </Items>
        </telerik:RadMenu>
        <div class="top5">
        ...
        <asp:MultiView ID="GridMultiView" runat="server" ActiveViewIndex="0">
            <asp:View ID="NoGroupingView" runat="server">
                <telerik:RadGrid ID="NoGroupRadGrid" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                    ...
                    OnNeedDataSource="NoGroupRadGrid_NeedDataSource" OnItemDataBound="NoGroupRadGrid_ItemDataBound"
                    ...
                    <MasterTableView AllowFilteringByColumn="false" Width="100%" DataKeyNames="Id,Status"
                        ...
                        <Columns>
                            ...
                            <telerik:GridDateTimeColumn DataField="AssessmentDateIn" HeaderText="Date In" UniqueName="AssessmentDateIn"
                                ...
                                HeaderStyle-Width="120px" AutoPostBackOnFilter="true" PickerType="DateTimePicker" />
                            <telerik:GridDateTimeColumn DataField="AssessmentDateOut" HeaderText="Date Out" UniqueName="AssessmentDateOut"
                                EmptyDataText="-" AllowFiltering="true" DataType="System.DateTime" DataFormatString="{0:dd/MM/yyyy HH:mm}"
                                HeaderStyle-Width="120px" AutoPostBackOnFilter="true" PickerType="DateTimePicker" />
                            ...
                            <telerik:GridTemplateColumn HeaderText="Extraction Officer" UniqueName="AssessmentOIC"
                                DataField="FullName2" AutoPostBackOnFilter="true" DataType="System.String" SortExpression="AssessmentOIC">
                                <ItemTemplate>
                                    <%# (String.IsNullOrEmpty(Eval("AssessmentOIC").ToString()) ? "-" : Eval("AssessmentOIC"))%>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="PeOIC" UniqueName="PeOIC" DataField="PeOIC"
                                HeaderStyle-Width="70px" AutoPostBackOnFilter="true" DataType="System.String"
                                SortExpression="PeOIC">
                                <ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Ref No" UniqueName="RefNo" DataField="RefNo"
                                ...
                                <ItemTemplate>
                                    <asp:HyperLink ID="ViewRefHyperLink" runat="server" NavigateUrl='<%# String.Format("View.aspx?id={0}", Eval("Id")) %>'
                                        Target="_blank">
                                    <%# Eval("RefNo")%>
                                    </asp:HyperLink>
                                    ...
                                    &nbsp;<asp:Image runat="server" ID="WorksheetImage" Visible="false" />
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Aging" UniqueName="Aging" DataField="AssessmentDateIn"
                                HeaderStyle-Width="70px" AutoPostBackOnFilter="true" DataType="System.String"
                                SortExpression="AssessmentDateIn">
                                <ItemTemplate>
            ...
            <asp:View ID="GroupByDateView" runat="server">
                <telerik:RadGrid ID="GroupByDateRadGrid" runat="server" AutoGenerateColumns="False"
                    ...
                    <PagerStyle Mode="NextPrevAndNumeric" Width="100%" />
                    <MasterTableView AllowFilteringByColumn="false" Width="100%" DataKeyNames="AssessmentDateIn"
                        ClientDataKeyNames="AssessmentDateIn" GroupLoadMode="Client" Name="GroupByDatemasterTable">
                        <SortExpressions>
                            <telerik:GridSortExpression FieldName="AssessmentDateIn" SortOrder="Descending"></telerik:GridSortExpression>
                        </SortExpressions>
                        <NoRecordsTemplate>
                        ...
                        <Columns>
                            ...
                            <telerik:GridDateTimeColumn DataField="AssessmentDateOut" HeaderText="Date Out" UniqueName=""
                                EmptyDataText="-" AllowFiltering="true" DataType="System.DateTime" AutoPostBackOnFilter="true"
                                PickerType="DateTimePicker" />
                            <telerik:GridTemplateColumn HeaderText="Status" UniqueName="" DataField="" AutoPostBackOnFilter="true"
                                DataType="System.String" SortExpression="">
                                <ItemTemplate>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Extraction OIC" UniqueName="AssessmentOIC"
                                DataField="" AutoPostBackOnFilter="true" DataType="System.String" SortExpression="">
                                <ItemTemplate>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="PeOIC" UniqueName="PeOIC" DataField="" AutoPostBackOnFilter="true"
                                DataType="System.String" SortExpression="">
                                <ItemTemplate>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Case OIC" UniqueName="CaseOIC" DataField=""
                                AutoPostBackOnFilter="true" DataType="System.String" SortExpression="">
                                <ItemTemplate>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Ref No" UniqueName="RefNo" DataField="" AutoPostBackOnFilter="true"
                                DataType="System.String" SortExpression="">
                                <ItemTemplate>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            ...
                            <telerik:GridTemplateColumn HeaderText="Sets" UniqueName="" DataField="" AutoPostBackOnFilter="true"
                                DataType="System.String" SortExpression="">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="SetInformationLabel"></asp:Label>
                                </ItemTemplate>
                            </telerik:GridTemplateColumn>
                            <telerik:GridTemplateColumn HeaderText="Aging" UniqueName="Aging" DataField="" AutoPostBackOnFilter="true"
                                DataType="System.String" SortExpression="">
                                <ItemTemplate>
                                    <asp:Label ID="AgingLabel" runat="server"></asp:Label>
                                </ItemTemplate>
    ...
    <%--<asp:ObjectDataSource ID="GetNricObjectDataSource" runat="server" SelectMethod="GetNricForCompletenessDropDownList"
                ...
                if (grid == null) {
                    ...
                    if (detailTableCount > 0) {
                        ...
                        if (selectedIndeces.lastIndexOf(',')) {
                            ...
                            if (navigateUrl == "#") {
                                if (text == "Assign") {
                                    ShowWindow('Assign.aspx?id=' + selectedIndeces, 470, 470);
                                }
                                    ...
                                    ShowWindow('CloseApp.aspx?id=' + selectedIndeces, 550, 400);
                                }
                                else if (text == "Resend") {
                                    ShowWindow('Resend.aspx?id=' + selectedIndeces, 470, 470);
                                }
                                eventArgs.set_cancel(true);
                            }
                        }
                        else { // if no st exist
                            alert("Please select at least 1 Application.");
                        }
                    }
                }
                else { // for no group
    ...
    <asp:ObjectDataSource ID="GetUserObjectDataSource" runat="server" SelectMethod="GetUserBySection"

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DivisionFunction.aspx.cs" Inherits="IncomeAssessment_DivisionFunction" 
Title="DWMS - Division Function(Income Assessment)" MasterPageFile="~/Blank.master"%>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
    <div class="title">
        <asp:Label ID="TitleLabel" runat="server" Text="Division Function" />
    </div>
    <asp:Panel ID="ConfirmPanel" runat="server" CssClass="reminder-green top10 bottom15"
        Visible="false" EnableViewState="false">
        <asp:Label ID="lblConfirm" runat="server" CssClass="list" Text="Division successful."></asp:Label>
    </asp:Panel>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function ResizeAndClose(width, height) {
                ...
                GetRadWindow().BrowserWindow.UpdateParentPage('divide');

<%@ Page Language="C#" MasterPageFile="~/OneColumn.master" AutoEventWireup="true"
    CodeFile="AssignmentHle.aspx.cs" Inherits="Verification_AssignmentHle" Title="DWMS - HLE Pending Assignment (Verification)" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="server">
    ...
    <asp:Panel ID="FormPanel" runat="server" CssClass="inputform">
        ...
        <div class="header">
            <div class="left">
                Assigned Cases for Verification Officers</div>
            <div class="right">
                <!---->
            </div>
        </div>
            ...
            <asp:Repeater ID="Repeater1" runat="server" OnItemCreated="Repeater1_ItemCreated"
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td valign="top">
                            <asp:TextBox ID="ATextBox" runat="server" Width="40px" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:TextBox ID="BTextBox" runat="server" Width="40px" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:TextBox ID="CTextBox" runat="server" Width="40px" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:TextBox ID="DTextBox" runat="server" Width="40px" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:TextBox ID="ETextBox" runat="server" Width="40px" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:TextBox ID="FTextBox" runat="server" Width="40px" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:TextBox ID="HTextBox" runat="server" Width="40px" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:TextBox ID="LTextBox" runat="server" Width="40px" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:TextBox ID="NTextBox" runat="server" Width="40px" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:TextBox ID="TTextBox" runat="server" Width="40px" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:TextBox ID="XTextBox" runat="server" Width="40px" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:Label ID="IndividualTotalLabel" runat="server" Text="0" />
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                    <tr class="bg-blue">
                        ...
                        <td valign="top">
                            <asp:Label ID="FooterATotalLabel" runat="server" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:Label ID="FooterBTotalLabel" runat="server" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:Label ID="FooterCTotalLabel" runat="server" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:Label ID="FooterDTotalLabel" runat="server" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:Label ID="FooterETotalLabel" runat="server" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:Label ID="FooterFTotalLabel" runat="server" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:Label ID="FooterHTotalLabel" runat="server" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:Label ID="FooterLTotalLabel" runat="server" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:Label ID="FooterNTotalLabel" runat="server" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:Label ID="FooterTTotalLabel" runat="server" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:Label ID="FooterXTotalLabel" runat="server" Text="0" />
                        </td>
                        <td valign="top">
                            <asp:Label ID="FooterTotalLabel" runat="server" Text="0" />
                        </td>
                    </tr>
                    <tr class="bg-blue">
                        <td valign="top" width="150px">

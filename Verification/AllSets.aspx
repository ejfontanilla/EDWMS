<%@ Page Language="C#" MasterPageFile="~/OneColumn.master" AutoEventWireup="true"
    CodeFile="AllSets.aspx.cs" Inherits="Verification_SetList" Title="DWMS - All Sets (Verification)" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
    <div class="title">
        <%-- Pending Assignment and Verification in Progress--%>All Sets
    </div>
    <asp:Panel ID="FormPanel" runat="server" CssClass="inputform">
        <telerik:RadComboBox ID="ChannelRadComboBox" runat="server" ZIndex="30000" Height="200"
            Width="120" DropDownWidth="120" AppendDataBoundItems="true" Skin="Windows7" ExpandAnimation-Duration="100"
        ...
        <telerik:RadComboBox ID="StatusRadComboBox" runat="server" ZIndex="30000" Height="200"
            Width="150" DropDownWidth="150" AppendDataBoundItems="true" Skin="Windows7" ExpandAnimation-Duration="100"
            AutoPostBack="false" CausesValidation="false" CollapseAnimation-Duration="200">
            <Items>
        ...
        <%--        <telerik:RadComboBox runat="server" ID="RefNoRadComboBox" AllowCustomText="true"
            ...
            DataValueField="Id" Filter="Contains" Skin="Windows7" EmptyMessage="Type a Ref No..."
            DataSourceID="ObjectDataSource1" Width="150" EnableVirtualScrolling="true" ItemsPerRequest="20">
        </telerik:RadComboBox>--%>
        ...
        <telerik:RadComboBox ID="UserRadComboBox" runat="server" AllowCustomText="true" AutoPostBack="true"
            CausesValidation="false" Skin="Windows7" EnableAutomaticLoadOnDemand="true" DataTextField="Name"
            MarkFirstMatch="True" DataValueField="UserId" Filter="Contains" EmptyMessage="Type a Verification OIC..."
            Width="180" EnableVirtualScrolling="true" ItemsPerRequest="20">
        </telerik:RadComboBox>
        &nbsp;
        <%--        <telerik:RadComboBox runat="server" ID="AcknowledgeNumberRadComboBox" AllowCustomText="true"
            AutoPostBack="false" CausesValidation="false" Skin="Windows7" EnableAutomaticLoadOnDemand="true"
        ...
        <%--<telerik:RadComboBox runat="server" ID="NricRadComboBox" AllowCustomText="true" AutoPostBack="false"
            CausesValidation="false" Skin="Windows7" EnableAutomaticLoadOnDemand="true" DataTextField="Nric"
            MarkFirstMatch="True" DataValueField="Nric" Filter="Contains" EmptyMessage="Type a NRIC No..."
            DataSourceID="GetNricObjectDataSource" Width="120" EnableVirtualScrolling="true"
        ...
        <telerik:RadMenu ID="RadMenuHomeComplete" runat="server" Skin="Sitefinity" Font-Names="Arial, Helvetica, sans-serif"
            Font-Size="12px" Style="z-index: 1;" Visible="true" Width="100%" OnClientItemClicking="onClicking"
            EnableOverlay="False">
            <Items>
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" OnAjaxRequest="RadAjaxManager1_AjaxRequest"
        ...
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="RadAjaxManager1">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="FormPanel" LoadingPanelID="LoadingPanel1" />
                    <telerik:AjaxUpdatedControl ControlID="NoGroupRadGrid" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>

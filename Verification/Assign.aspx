<%@ Page Language="C#" MasterPageFile="~/Blank.master" AutoEventWireup="true"
    CodeFile="Assign.aspx.cs" Inherits="Verification_AssignSet" Title="DWMS - Assign Set (Verification)" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
    <div class="title">
        <asp:Label ID="TitleLabel" runat="server" Text="Assign Set" />
    </div>
    <asp:Panel ID="ConfirmPanel" runat="server" CssClass="reminder-green top10 bottom15"
        Visible="false" EnableViewState="false">
        The set(s) have been assigned to the user.
    </asp:Panel>
            ...
            <table>
                <tr>
                    <td valign="top" style="width: 30%;">
                        <span class="label">Sets to Assign</span>                        
                    </td>
                    <td>       
                ...
                <tr>                    
                    <td valign="top">
                        <span class="label">Verification OIC</span><span class="form-error">&nbsp;*</span>
                    </td>
                    <td>
                        ...
                        <asp:CustomValidator ID="UserCustomValidator" runat="server" Display="Dynamic" CssClass="form-error" 
                            ErrorMessage="<br />Please select a verifying officer." 
    ...
    <asp:ObjectDataSource ID="GetUserObjectDataSource" runat="server"
        SelectMethod="GetUserBySectionForVerification" OnSelecting="GetUserObjectDataSource_Selecting"

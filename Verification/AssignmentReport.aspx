<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignmentReport.aspx.cs" Inherits="Verification_AssignmentReport"
    MasterPageFile="~/OneColumn.master" Title="DWMS - Assignment Report (Verification)" %>
            ...
            <MasterTableView AllowFilteringByColumn="false" Width="100%">
                ...
                <Columns>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Verification OIC" UniqueName="VerificationOIC"
                        DataField="VerificationOIC" AutoPostBackOnFilter="true" DataType="System.String" SortExpression="VerificationOIC"
                        HeaderStyle-Width="200px">
                        <ItemTemplate>
                            <%# (String.IsNullOrEmpty(Eval("VerificationOIC").ToString()) ? "-" : Eval("VerificationOIC"))%>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderText="Set No" UniqueName="SetNo" DataField="SetNo"
                        AutoPostBackOnFilter="true" DataType="System.String" SortExpression="SetNo" HeaderStyle-Width="120px">
                        <ItemTemplate>
                            <asp:HyperLink ID="ViewSetHyperLink" runat="server" Text='<%# Eval("SetNo")%>'
                    ...
                    <telerik:GridTemplateColumn HeaderText="Ref No" UniqueName="RefNo" DataField="RefNo"
                        ...
                        <ItemTemplate>
                            <asp:HyperLink ID="ViewSetHyperLink1" runat="server" Text='<%# Eval("Refno")%>'
                                NavigateUrl='<%# String.Format("View.aspx?id={0}", Eval("Id")) %>' Target="_blank">
                                <%# Eval("Refno")%>
                            </asp:HyperLink>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderText="PeOIC" UniqueName="PeOIC" DataField="PeOIC" HeaderStyle-Width="50px"
                        AutoPostBackOnFilter="true" DataType="System.String" SortExpression="PeOIC">
                        <ItemTemplate>
                            <%# (String.IsNullOrEmpty(Eval("PeOIC").ToString()) ? "-" : Eval("PeOIC"))%>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                    <telerik:GridTemplateColumn HeaderText="Case OIC" UniqueName="CaseOIC" DataField="CaseOIC" HeaderStyle-Width="50px"
                    ...
                    <telerik:GridDateTimeColumn DataField="DateAssigned" HeaderText="Date Assigned" UniqueName="DateAssigned"
                        ...
                        AutoPostBackOnFilter="true" PickerType="DateTimePicker" HeaderStyle-Width="100px" />
                    <telerik:GridTemplateColumn HeaderText="Status" UniqueName="Status" DataField="Status"
                        AutoPostBackOnFilter="true" DataType="System.String" SortExpression="Status" HeaderStyle-Width="130px">
                        <ItemTemplate>
                    ...
                    <telerik:GridTemplateColumn HeaderText="Aging" UniqueName="Aging" DataField="VerificationDateIn" HeaderStyle-Width="70px"

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EmploymentPass.ascx.cs" Inherits="Verification_Control_EmploymentPass" %>
...
<table>
     <tr>
        <td colspan="2">
            <asp:Label runat="server" ID="lblDateRangeError" Text="Date of Expiry must be after today" Visible="false" CssClass="form-error"></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="left">
            <span class="label">Date of Expiry</span><span class="form-error" runat="server" id="Span1">&nbsp;*</span>
            <br/><uc:DateFormatLabel runat="server" ID="DateFormatLabel"/>
        </td>
        <td>
            <uc:DateTextBox runat="server" ID="DateOfExpiry" RequiredFieldErrorMessage="Date of Expiry is required." Visible="true"/>
        </td>
    </tr>
</table>
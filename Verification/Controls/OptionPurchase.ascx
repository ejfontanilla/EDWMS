<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OptionPurchase.ascx.cs" Inherits="Verification_Controls_OptionPurchase" %>
...
<table>
     <tr>
        <td colspan="2">
            <asp:Label runat="server" ID="lblDateRangeError" Text="Date of Option to Purchase must be before today" Visible="false" CssClass="form-error"></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="left">
            <span class="label">Date Of Option to Purchase</span><span id="Span1" class="form-error" runat="server">&nbsp;*</span>
            <br/><uc:DateFormatLabel runat="server" ID="DateFormatLabel"/>
        </td>
        <td>
            <uc:DateTextBox runat="server" ID="DateOfOption" RequiredFieldErrorMessage="Date of Option to Purchase is required." Visible="true"/>
        </td>
    </tr>

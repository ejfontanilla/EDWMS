<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GLA.ascx.cs" Inherits="Verification_Control_GLA" %>
...
<table>
    ...
    <tr>
        <td class="left">
            <span class="label">Date of Issue</span><span class="form-error" runat="server" id="Span2">&nbsp;*</span>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidatorNameOfChild" runat="server" CssClass="form-error" ControlToValidate="IdNo" 
    ...
    <tr>
        <td>
            <span class="label">Name<br />(Deceased)</span>
        </td>
        <td>
            <asp:TextBox runat="server" ID="NameDeceased"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" CssClass="form-error" ControlToValidate="NameDeceased" 
                ErrorMessage="<br />Name (Deseased) is required." Display="Dynamic"></asp:RequiredFieldValidator>
            <asp:HiddenField runat="server" ID="NameDeceasedId" />
        </td>
    </tr>
</table>
...
public partial class Verification_Control_CBR : System.Web.UI.UserControl
{
    private String _CurrentDocType;
    protected string DocType = "CBR";
    ...
    public void LoadData(int docId, int docRefId, string referencePersonalTable, Boolean isUnderHouseholdStructure)
    {
        ...
        if (CurrentDocType.ToLower().Equals(DocType.ToLower()))
        {
            ...
            {
                if (metaDataRow.FieldName.ToLower().Trim().Equals(DocTypeMetaDataCBREnum.DateOfReport.ToString().ToLower()))
                {
    ...
    private void SaveDataDetails(int docId, int docRefId, string referencePersonalTable)
    {
        ...
        if (DateOfReport.DateIdValue.Length == 0)
            DateOfReport.DateIdValue = metadataDb.Insert(DocTypeMetaDataCBREnum.DateOfReport.ToString(), DateOfReport.DateValue, docId, false).ToString();
        else

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Baptism.ascx.cs" Inherits="Verification_Control_Baptism" %>
...
<table>
     <tr>
        <td colspan="2">
            <asp:Label runat="server" ID="lblDateRangeError" Text="Date of Baptism must be before today" Visible="false" CssClass="form-error"></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="left">
            <span class="label">Date of Baptism</span><span class="form-error" runat="server" id="Span2">&nbsp;*</span>
            <br/><uc:DateFormatLabel runat="server" ID="DateFormatLabel"/>
        </td>
        <td>
            <uc:DateTextBox runat="server" ID="DateOfBaptism" RequiredFieldErrorMessage="Date of Baptism is required." Visible="true"/>
        </td>
    </tr>
</table>
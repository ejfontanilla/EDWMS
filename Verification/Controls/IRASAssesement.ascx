<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IRASAssesement.ascx.cs" Inherits="Verification_Control_IRASAssesement" %>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidatorYearOfAssessment" runat="server" CssClass="form-error" ControlToValidate="YearOfAssessment" 
                ErrorMessage="<br />Year of assessment is required." Display="Dynamic" Enabled="false"></asp:RequiredFieldValidator>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DivorceCertificate.ascx.cs"
    Inherits="Verification_Control_DivorceCertificate" %>
...
<table>
    <tr>
        <td colspan="2">
            <asp:Label runat="server" ID="lblDateRangeError" Text="Date of Divorce must be before today"
    ...
    <tr>
        <td>
            <span class="label">Date of Divorce </span><span class="form-error" runat="server"
                id="DateOfDivorceSpan" visible="false">&nbsp;*</span>
            <br />
            <span class="note">(<%= Dwms.Bll.Format.GetMetaDataDateFormat()%>)</span><!--Modified by Edward 2016/05/12 Take out DateFormatLabel UC-->
        </td>
        <td>
            <uc:DateTextBox runat="server" ID="DateOfDivorce" RequiredFieldErrorMessage="Date of Divorce is required."
                EnableRequiredField="true" Visible="true" />
        </td>
    </tr>
    <tr>
        <td>
            <span class="label">Divorce Case No</span><span class="form-error" runat="server"
                id="DivorceCaseSpan" visible="true">*</span>
        </td>
        <td>
            <asp:TextBox runat="server" ID="DivorceCaseNo"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidatorDivorceCaseNo" runat="server"
                CssClass="form-error" ControlToValidate="DivorceCaseNo" ErrorMessage="<br />Divorce Case No is required."
    ...
    <tr>
        <td class="left">
            <span class="label">Identity No (Requestor) </span>
        </td>
        <td>
    ...
    <tr>
        <td>
            <span class="label">ID Type (Requestor)</span><span class="form-error" runat="server"
                id="Span2">&nbsp;*</span>
        </td>
        <td>

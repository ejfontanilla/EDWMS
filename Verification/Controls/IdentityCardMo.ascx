<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IdentityCardMo.ascx.cs" Inherits="Verification_Controls_IdentityCardMo" %>
...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidatorNameOfMother" runat="server"
                CssClass="form-error" ControlToValidate="NameOfMother" ErrorMessage="<br />Name of Mother is required."
                Display="Dynamic"></asp:RequiredFieldValidator>

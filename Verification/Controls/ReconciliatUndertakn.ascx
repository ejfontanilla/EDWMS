<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReconciliatUndertakn.ascx.cs" Inherits="Verification_Control_ReconciliatUndertakn" %>
...
<table>
     <tr>
        <td colspan="2">
            <asp:Label runat="server" ID="lblDateRangeError" Text="Date of Declaration must be after today" Visible="false" CssClass="form-error"></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="left">
            <span class="label">Date of Declaration</span><span class="form-error" runat="server" id="Span1">&nbsp;*</span>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DocOfFinCommitment.ascx.cs" Inherits="Verification_Controls_DocOfFinCommitment" %>
...
<table>
    ...
    <tr>
        <td class="left">
            <span class="label">Date Of Document</span><span id="Span1" class="form-error" runat="server">&nbsp;*</span>

...
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DeathCertificatePA.ascx.cs" Inherits="Verification_Controls_DeathCertificatePA" %>
...
<table>
    ...
    <tr>
        <td class="left">
            <span class="label">Identity No of Father/Mother</span><span id="Span1" class="form-error" runat="server">&nbsp;*</span>
        </td>
        <td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidatorIdentityNoOfMother" runat="server" CssClass="form-error" ControlToValidate="IdentityNoOfMother" 
                ErrorMessage="<br />Identity No of father/mother is required." Display="Dynamic"></asp:RequiredFieldValidator>
    ...
    <tr>
        <td>
            <span class="label">ID Type of Father/Mother</span><span id="Span6" class="form-error" runat="server">&nbsp;*</span>
        </td>
        <td>
    ...
    <tr>
        <td>
            <span class="label">Name of Father/Mother</span><span class="form-error" runat="server" id="Span3">&nbsp;*</span>
        </td>
        <td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidatorNameOfMother" runat="server" CssClass="form-error" ControlToValidate="NameOfMother" 
                ErrorMessage="<br />Name of father/mother is required." Display="Dynamic"></asp:RequiredFieldValidator>

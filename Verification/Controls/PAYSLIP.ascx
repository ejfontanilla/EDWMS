<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PAYSLIP.ascx.cs" Inherits="Verification_Control_PAYSLIP" %>
...
<%--    <tr runat="server" id="NameOfCompanyTR">
    ...
    <tr runat="server" id="AllowanceTR">
        <td class="left">
            <span class="label">Allowance</span><span class="form-error" runat="server" id="Span2">&nbsp;*</span>
        </td>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DeedSeverance.ascx.cs" Inherits="Verification_Control_DeedSeverance" %>
...
<table>
     <tr>
        <td colspan="2">
            <asp:Label runat="server" ID="lblDateRangeError" Text="Date of Severance must be before today" Visible="false" CssClass="form-error"></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="left">
    ...
    <tr>
        <td>
            <span class="label">Date of Severance</span><span class="form-error" runat="server" id="DateOfMarriageSpan" >&nbsp;*</span>
            <br/><uc:DateFormatLabel runat="server" ID="DateFormatLabel"/>
        </td>
        <td>
            <uc:DateTextBox runat="server" ID="DateOfSeverance" RequiredFieldErrorMessage="Date of Severance is required." Visible="true"/>
        </td>
    </tr>

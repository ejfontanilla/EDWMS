<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StudentPass.ascx.cs" Inherits="Verification_Control_StudentPass" %>
...
<table>
    ...
    <tr runat="server" id="EducationLevelTR">
        <td>
            <span class="label">Education Level</span><%--<span class="form-error" runat="server" id="Span2">&nbsp;*</span>--%>
        </td>
        <td>
            <telerik:RadComboBox runat="server" ID="EducationLevel"/>
            <asp:HiddenField runat="server" ID="EducationLevelId" />
        </td>
    </tr>
<%--    <tr>
        <td colspan="2" class="form-error"><%= Dwms.Bll.Constants.MandatoryMsg%></td>
    </tr>
--%></table>
<%@ Control Language="C#" AutoEventWireup="true" CodeFile="OrderofCourt.ascx.cs" Inherits="Verification_Control_OrderofCourt" %>
...
<table>
     <tr>
        <td colspan="2">
            <asp:Label runat="server" ID="lblDateRangeError" Text="Date of Court Order must be before today" Visible="false" CssClass="form-error"></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="left">
            <span class="label">Date of Court Order</span><span class="form-error" runat="server" id="Span2">&nbsp;*</span>
            <br/><uc:DateFormatLabel runat="server" ID="DateFormatLabel"/>
        </td>
        <td>
            <uc:DateTextBox runat="server" ID="CourtOrderDate" RequiredFieldErrorMessage="Date of Court Order is required." Visible="true"/>
        </td>
    </tr>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IdentityCardChild.ascx.cs"
    Inherits="Verification_Controls_IdentityCardChild" %>
...
<table>
    ...
    <tr>
        <td>
            <span class="label">Name of Child</span><span class="form-error" runat="server" id="Span3">&nbsp;*</span>
        </td>
        <td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidatorNameOfChild" runat="server"
                CssClass="form-error" ControlToValidate="NameOfChild" ErrorMessage="<br />Name of Child is required."
                Display="Dynamic"></asp:RequiredFieldValidator>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DivorceCertNRIC.ascx.cs" Inherits="Verification_Control_DivorceCertNRIC" %>
...
<table>
    ...
    <tr><td colspan="2"><div class="grey-header-light">NRIC</div></td></tr>
    <tr>
        <td class="left">
            <span class="label">Identity No (NRIC) </span><span class="form-error" runat="server" id="Span1" visible="false">&nbsp;*</span>
        </td>
        <td>
            <asp:TextBox runat="server" ID="IdentityNoNRIC"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidatorIdentityNoNRIC" runat="server" CssClass="form-error" ControlToValidate="IdentityNoNRIC" 
                ErrorMessage="<br />Identity No is required." Display="Dynamic"></asp:RequiredFieldValidator>
            <asp:CustomValidator id="NricFinCustomValidatorNRIC" runat="server" 
                ControlToValidate="IdentityNoNRIC" Display="Dynamic"  
                OnServerValidate="NricCustomValidatorNRIC" CssClass="form-error"
    ...
    <tr>
        <td>
            <span class="label">ID Type (NRIC)</span>
        </td>
        <td>
            <asp:RadioButtonList runat="server" ID="IDTypeNRIC" AutoPostBack="true" CausesValidation="false" RepeatDirection="Horizontal" />
            <asp:HiddenField runat="server" ID="IDTypeNRICId" />
        </td>
    </tr>
    <tr>
        <td>
            <span class="label">Name (NRIC)</span>
        </td>
        <td>
            <uc:NricTextBox runat="server" ID="NameOfNRIC" EnableRequiredField="true" Visible="true"  ErrorMessage="<br />Identity No is required."/>
        </td>
    </tr>

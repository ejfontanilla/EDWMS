<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DivorceDocInterim.ascx.cs" Inherits="Verification_Control_DivorceDocInterim" %>
...
<table>
    ...
    <tr>
        <td>
            <span class="label">Date of Order </span><span class="form-error" runat="server" id="DateOfOrderSpan" visible="false">&nbsp;*</span>
            <br/><uc:DateFormatLabel runat="server" ID="DateFormatLabel"/>
        </td>
        <td>
            <uc:DateTextBox runat="server" ID="DateOfOrder" RequiredFieldErrorMessage="Date of Order is required." EnableRequiredField="true" Visible="true"/>
        </td>
    </tr>

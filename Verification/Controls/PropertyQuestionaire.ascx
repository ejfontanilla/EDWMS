<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PropertyQuestionaire.ascx.cs" Inherits="Verification_Control_PropertyQuestionaire" %>
...
<table>
     <tr>
        <td colspan="2">
            <asp:Label runat="server" ID="lblDateRangeError" Text="Date of Document must be after today" Visible="false" CssClass="form-error"></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="left">
            <span class="label">Date of Document</span><span class="form-error" runat="server" id="Span2">&nbsp;*</span>
            <br/><uc:DateFormatLabel runat="server" ID="DateFormatLabel"/>
        </td>
        <td>
            <uc:DateTextBox runat="server" ID="DateOfDocument" RequiredFieldErrorMessage="Date of Document is required." Visible="true"/>
        </td>
    </tr>

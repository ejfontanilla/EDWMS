<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DivorceCertChild.ascx.cs" Inherits="Verification_Control_DivorceCertChild" %>
...
<table>
    ...
    <tr><td colspan="2"><div class="grey-header-light">Child</div></td></tr>
    <tr>
        <td class="left">
            <span class="label">Identity No (Child) </span><span class="form-error" runat="server" id="Span1" visible="false">&nbsp;*</span>
        </td>
        <td>
            <asp:TextBox runat="server" ID="IdentityNoChild"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidatorIdentityNoChild" runat="server" CssClass="form-error" ControlToValidate="IdentityNoChild" 
            ...
            <asp:CustomValidator id="NricFinCustomValidatorRequestor" runat="server" 
                ControlToValidate="IdentityNoChild" Display="Dynamic"  
                OnServerValidate="NricCustomValidatorChild" CssClass="form-error"
                ErrorMessage="Enter a valid ID no. ex(S1234567A).">
            </asp:CustomValidator>
            <asp:HiddenField runat="server" ID="IdentityNoChildId" />
        </td>
    </tr>
    <tr>
        <td>
            <span class="label">ID Type (Child)</span>
        </td>
        <td>
            <asp:RadioButtonList runat="server" ID="IDTypeChild" AutoPostBack="true" CausesValidation="false" RepeatDirection="Horizontal"/>
            <asp:HiddenField runat="server" ID="IDTypeChildId" />
        </td>
    </tr>
    <tr>
        <td>
            <span class="label">Name (Child)</span>
        </td>
        <td>

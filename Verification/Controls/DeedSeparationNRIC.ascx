<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DeedSeparationNRIC.ascx.cs" Inherits="Verification_Controls_DeedSeparationNRIC" %>
...
<table>
    ...
    <tr>
        <td class="left">
            <span class="label">Identity No (NRIC) </span><span class="form-error" runat="server" id="Span1" >&nbsp;*</span>
        </td>
        <td>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MarriageCertChild.ascx.cs" Inherits="Verification_Control_MarriageCertChild" %>
...
<table>
    ...
    <tr><td colspan="2"><div class="grey-header-light">Child - Image</div></td></tr>
    <tr>
        <td class="left">
            <span class="label">Identity No</span><span id="Span3" class="form-error" runat="server">&nbsp;*</span>
        </td>
        <td>
            <asp:TextBox runat="server" ID="IdentityNoImageChild"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidatorIdentityNoImageChild" runat="server" CssClass="form-error" ControlToValidate="IdentityNoImageChild" 
                ErrorMessage="<br />Identity No is required." Display="Dynamic"></asp:RequiredFieldValidator>
            <asp:CustomValidator id="CustomValidator1" runat="server" 
                ControlToValidate="IdentityNoImageChild" Display="Dynamic"  
                OnServerValidate="NricCustomValidatorChild" CssClass="form-error"
                ErrorMessage="Enter a valid ID no. ex(S1234567A)." >
            </asp:CustomValidator>
            <asp:HiddenField runat="server" ID="IdentityNoImageChildId" />
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <asp:RadioButtonList runat="server" ID="IDTypeImageChild" AutoPostBack="true" CausesValidation="false" RepeatDirection="Horizontal" />
            <asp:HiddenField runat="server" ID="IDTypeImageChildId" />
        </td>
    </tr>
    <tr>
        <td>

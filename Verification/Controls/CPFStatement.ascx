<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CPFStatement.ascx.cs" Inherits="Verification_Control_CPFStatement" %>
...
<table>
    ...
    <tr>
        <td class="left">
            <span class="label">From Date </span><span class="form-error" runat="server" id="StartDateSpan">&nbsp;*</span>
    ...
    <tr>
        ...
        <td>
            <uc:DateTextBox runat="server" ID="ToDate" EnableRequiredField="true" RequiredFieldErrorMessage="To Date is required" />
        </td>
    </tr>
</table>
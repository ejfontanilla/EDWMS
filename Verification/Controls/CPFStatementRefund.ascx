<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CPFStatementRefund.ascx.cs" Inherits="Verification_Control_CPFStatementRefund" %>
...
<table>
     <tr>
        <td colspan="2">
            <asp:Label runat="server" ID="lblDateRangeError" Text="Date of Statement must be before today" Visible="false" CssClass="form-error"></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="left">
            <span class="label">Date of Statement</span><br />
            <br/><uc:DateFormatLabel runat="server" ID="DateFormatLabel"/>
        </td>
        <td>
            <uc:DateTextBox runat="server" ID="DateOfStatement" EnableRequiredField="true" RequiredFieldErrorMessage="Date of Statement is required"/>
        </td>
    </tr>
</table>
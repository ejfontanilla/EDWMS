<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NSORDCertificate.ascx.cs" Inherits="Verification_Controls_NSORDCertificate" %>
...
<table>
     <tr>
        <td colspan="2">
            <asp:Label runat="server" ID="lblDateRangeError" Text="Date ORD must be before today" Visible="false" CssClass="form-error"></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="left">
            <span class="label">Date ORD</span><span id="Span1" class="form-error" runat="server">&nbsp;*</span>
            <br/><uc:DateFormatLabel runat="server" ID="DateFormatLabel"/>
        </td>
        <td>
            <uc:DateTextBox runat="server" ID="DateORD" RequiredFieldErrorMessage="Date ORD is required." Visible="true"/>
        </td>
    </tr>

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PurchaseAgreement.ascx.cs" Inherits="Verification_Control_PurchaseAgreement" %>
...
<table>
    ...
    <tr>
        ...
        <td>
            <uc:DateTextBox runat="server" ID="DateOfDocument" EnableRequiredField="true" RequiredFieldErrorMessage="Date of Document is required" Visible="true"/>
        </td>
    </tr>

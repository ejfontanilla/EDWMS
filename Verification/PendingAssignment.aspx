<%@ Page Language="C#" MasterPageFile="~/OneColumn.master" AutoEventWireup="true"
    CodeFile="PendingAssignment.aspx.cs" Inherits="Verification_SetList" Title="DWMS - Pending Assignment (Verification)" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
                ...
                <telerik:RadGrid ID="NoGroupRadGrid" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                    ...
                    <MasterTableView AllowFilteringByColumn="false" Width="100%" DataKeyNames="Id,Status"
                        ...
                        <Columns>
                            ...
                            <%-- Commented By Edward 30.10.2013 for optimizing performance -- %>
    <%--                        <telerik:GridTemplateColumn HeaderText="Source" UniqueName="Source" DataField="Source"
                            ...
                            <telerik:GridTemplateColumn HeaderText="Options" UniqueName="Options" AllowFiltering="false"
                                ...
                                <ItemTemplate>
                                    <asp:HyperLink ID="VerifyHyperLink" runat="server" NavigateUrl='<%# String.Format("AssignUser.aspx?id={0}", Eval("Id")) %>'
                                        Target="_blank">
                                        Verify
                                    </asp:HyperLink>
                                </ItemTemplate>

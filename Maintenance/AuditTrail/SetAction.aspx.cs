...
public partial class Maintenance_AuditTrail_SetAction : System.Web.UI.Page
{
    //bool isExport = false;            Commented by Edward 2016/02/04 take out unused variables
    ...
    {
        TitleLabel.Text = "Set Action";
        LogActionDb logActionDb = new LogActionDb();

            RadGridLog.Columns[3].Visible = true;
            RadGridLog.DataSource = logActionDb.GetSetAction();        
    }

<%@ Page Language="C#" MasterPageFile="~/Blank.master" AutoEventWireup="true"
    CodeFile="AddValues.aspx.cs" Inherits="Maintenance_MasterList_AddValues" Title="DWMS - Master List" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainColumn" runat="Server">
    <div class="title">
        <asp:Label ID="TitleLabel" runat="server" Text="Add Values" /></div>
        ...
        <div class="area">
            <table>
                <tr id="Tr1" runat="server">
                    <td valign="top">
                        <span class="label">Value</span><span class="form-error">&nbsp;*</span>
                    </td>
                    <td valign="middle">
